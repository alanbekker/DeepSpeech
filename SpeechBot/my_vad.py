...
class VoiceActivityDetector():
    ...
    def __init__(self,data,channels,rate):
        ...
        self.speech_energy_threshold = 0.75 #60% of energy in voice band
    ...
    def detect_speech(self):
        ...
        sum_full_energy_tot=0
        sum_voice_energy_tot=0
        speech_ratio_tot=0
        win=0
        while (sample_start < (len(data) - sample_window)):
            ...
            sum_voice_energy_tot+=sum_voice_energy
            sum_full_energy_tot+=sum_full_energy
            speech_ratio_tot+=speech_ratio
        speech_ratio_tot=speech_ratio_tot/win
        detected_windows = detected_windows.reshape(round(len(detected_windows)/2),2)
        detected_windows[:,1] = self._smooth_speech_detection(detected_windows)
        return detected_windows,sum_voice_energy_tot,sum_full_energy_tot,speech_ratio_tot
